...
public:
	...
	void Move_pack_man_arm_parts(DirectionY _move, DirectionY _direc_y, DirectionX _direc_x);
	
	YesNo Is_stnad_over();
	YesNo Is_stnad_under();
	
	DirectionY Get_stand_direction();
...
inline YesNo PackMan::Is_stnad_over()
{
	return ~_limit_stand_over.Get();
}

//----------------------------------------------------------------------//

inline YesNo PackMan::Is_stnad_under()
{
	return ~_limit_stand_under.Get();
}

//----------------------------------------------------------------------//

inline DirectionY PackMan::Get_stand_direction()
{
	return _direcion_stand;
}
