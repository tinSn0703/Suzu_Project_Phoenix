...
void UartSet :: Want_to_use_8th_bit (const YesNo _yes_no)
{
	if (_yes_no)	UartSet :: Use_8th_bit();
	else			UartSet :: Not_use_8th_bit();
}
...
/*	UartOperationBase													*/
/************************************************************************/
UartOperationBase :: UartOperationBase (UartNum _arg_uart_adrs)
...
void UartOperationBase :: Wait_transmit_completed ()
{
